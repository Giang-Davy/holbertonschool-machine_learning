...
def resnet50():
    ...
    proj_block2 = projection_block(id_block1_3, [128, 128, 512], s=2)  # stride=2 pour réduire les dimensions spatiales
    ...
    # Block 3 (conv4)
    # Projection Block ici pour ajuster la taille (de 512 à 1024)
    proj_block3 = projection_block(id_block2_3, [256, 256, 1024], s=2)  # stride=2
    ...
    # Block 4 (conv5)
    # Projection Block ici pour ajuster la taille (de 1024 à 2048)
    proj_block4 = projection_block(id_block3_5, [512, 512, 2048], s=2)  # stride=2
    ...
    output_layer = K.layers.Dense(1000, activation='softmax', kernel_initializer=initializer)(avg_pool)
