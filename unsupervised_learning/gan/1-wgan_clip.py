...
class WGAN_clip(keras.Model):
    def __init__(self, generator, discriminator, latent_generator, real_examples, batch_size=200, disc_iter=2, learning_rate=0.005):
        ...
        # Define optimizers
        self.generator.optimizer = tf.keras.optimizers.Adam(learning_rate=self.learning_rate, beta_1=self.beta_1, beta_2=self.beta_2)
        self.discriminator.optimizer = tf.keras.optimizers.Adam(learning_rate=self.learning_rate, beta_1=self.beta_1, beta_2=self.beta_2)
    ...
    def train_step(self,useless_argument):
        ...
        for _ in range(self.disc_iter):
            with tf.GradientTape() as tape:
                # Générer des échantillons réels et faux
                ...
                loss_discriminator = tf.math.reduce_mean(loss_fake) - tf.math.reduce_mean(loss_real)
